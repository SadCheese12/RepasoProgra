...
int main(int argc, char** argv){
    ...
    if(rank == 0){
        ...
        //Envio datos
        MPI_Send( &A[18], 24, MPI_INT, 1, 0, MPI_COMM_WORLD);
        MPI_Send( &A[42], 24, MPI_INT, 2, 0, MPI_COMM_WORLD);
        MPI_Send( &A[66], 24, MPI_INT, 3, 0, MPI_COMM_WORLD);
        ...
        MPI_Recv(paralelosTmp1.data(), 8, MPI_INT, 1, MPI_ANY_TAG, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
        MPI_Recv(paralelosTmp2.data(), 8, MPI_INT, 2, MPI_ANY_TAG, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
        MPI_Recv(paralelosTmp3.data(), 8, MPI_INT, 3, MPI_ANY_TAG, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
        ...
        MPI_Recv(datos.data(), 24, MPI_INT, MPI_ANY_SOURCE, MPI_ANY_TAG, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
        ...
        //devuelvo
        MPI_Send(aux.data(), 8, MPI_INT, 0, 0, MPI_COMM_WORLD);
    }
    MPI_Finalize();
    return 0;
}